...
const Two_UI_Component_Nineteen = () => {
    ...
    -----------
     <section>
        <div className="w-[90%] mx-auto py-16">
          <div className="flex flex-col lg:items-center justify-center w-full text-white">
            <h1 className="font-semibold custom-gray-800">The Right Plan for your business</h1>
              ...
              <div >
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="w-full">
                    <div className="py-5 px-4 bg-white border-gray   text-left">
                      <h4 className="text-2xl clr-dark-blue font-semibold pb-8 lg:text-start">Basic</h4>
                      <ul className="flex flex-col mb-6">
                        <li className="flex items-center mb-2.5">
                          <img src="/checkMark.png" className="mr-4" alt="check-mark" />
                        ...
                        <li className="flex items-center mb-2.5">
                          <img src="/checkMark.png" className="opacity-0 mr-4" alt="check-mark" />
                  ...
                  <div className="bg-lime-500">
                    <div className="py-5 px-4 bg-gold border-gray text-left">
                      <h4 className="text-2xl text-white font-semibold pb-8">Pro</h4>
                      <ul className="flex flex-col mb-6">
                        <li className="flex items-center mb-2.5">
                          <img src="/checkMarkWhite.png" className="mr-4" alt="check-mark" />
                        ...
                        <li className="flex items-center mb-2.5">
                          <img src="/checkMark.png" className="mr-4 opacity-0" alt="check-mark" />
...
export default Two_UI_Component_Nineteen