...
import { FaBootstrap, FaCss3Alt, FaHtml5, FaJava, FaNodeJs } from "react-icons/fa";
import { IoLogoFirebase } from "react-icons/io5";
import { RiReactjsFill, RiSupabaseFill } from "react-icons/ri";
import { SiAmazonrds, SiFastapi, SiHasura, SiMui, SiRadixui, SiRasa, SiSpring, SiStrapi, SiTailwindcss } from "react-icons/si";
import { DialogBox } from '@/components/DialogBox';

const Two_UI_Component_Twenty_Thirty_Two = () => {
...
----------
  ...
  .border-box-one{
    box-shadow: 3px 4px 25px rgb(0, 255, 64);
  }
  .border-box-two{
    box-shadow: 3px 4px 25px rgb(0, 89, 255);
  }
  .border-box-three{
    box-shadow: 3px 4px 25px rgb(234, 0, 255);
  }
  
  .border-box-four{
    box-shadow: 1px 2px 10px rgb(63, 199, 140);
  }
...
export default Two_UI_Component_Twenty_Thirty_Two
